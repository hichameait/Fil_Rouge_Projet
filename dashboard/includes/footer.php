<footer class="bg-gray-100 border-t">
        <div class="container mx-auto px-4 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 class="font-bold text-lg mb-4">DentalCare</h3>
                    <p class="text-gray-600 mb-4">Providing exceptional dental care for the whole family since 2005.</p>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li>
                            <a href="reservation.php" class="text-gray-600 hover:text-blue-600">
                                Book Appointment
                            </a>
                        </li>
                        <li>
                ...
                <div id="contact">
                    ...
                    <div class="mt-4">
                        <h4 class="font-medium mb-2">Office Hours</h4>
